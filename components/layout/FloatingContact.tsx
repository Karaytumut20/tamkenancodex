                  ...
                  <div key={rep.name} className="rounded-2xl border border-border bg-surface p-4 hover:border-primary-300 transition-all">
                    ...
                    <div className="mt-3.5 grid grid-cols-2 gap-2">
                      ...
                      <a
                        ...
                        className="flex items-center justify-center gap-1.5 rounded-xl bg-success-500 px-3 py-2.5 text-xs font-bold text-white hover:bg-success-600 transition-colors"
                      >
