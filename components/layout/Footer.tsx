      ...
      <Container className="py-10 md:py-16 lg:pt-24">
        <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-5">
          <div className="md:pr-4">
            <Logo />
            <p className="mt-4 text-sm leading-6 text-[#b8c7dd] md:mt-5 md:leading-7">{siteConfig.description}</p>
            <div className="mt-4 grid gap-2 text-sm text-[#b8c7dd] sm:grid-cols-2 md:mt-5 md:grid-cols-1 md:gap-3">
              ...
              <p className="flex gap-2 sm:col-span-2 md:col-span-1"><MapPin className="mt-0.5 h-4 w-4 shrink-0 text-primary-300" /> {siteConfig.address}</p>
            </div>
          </div>
