...
export function ServiceTemplate({
  ...
  const serviceWhatsappHref = whatsappUrl(`Merhaba, PrimeSec Teknoloji web sitenizde yer alan hizmet hakkında bilgi almak istiyorum.

Hizmet: ${page.title}
Sayfa URL: ${siteConfig.siteUrl}${href}

Bu hizmet için detaylı bilgi ve teklif alabilir miyim?`);
      ...
      <section className="bg-white py-16 md:py-20 border-t border-border">
        <Container className="grid gap-12 xl:grid-cols-12 xl:items-center">
          ...
          <div className="xl:col-span-5 relative group">
            ...
            <div className="relative overflow-hidden rounded-[32px] border border-border bg-[#FFFFFF] p-6 flex flex-col justify-between min-h-[380px]">
              {/* Full Image */}
              <div className="relative w-full h-[280px] overflow-hidden rounded-2xl bg-slate-50 flex items-center justify-center">
                <Image
                  src={page.heroImage}
                  alt={page.title}
                  fill
              ...
              <div className="mt-6 w-full">
                <ButtonLink
                  ...
                  variant="whatsapp"
                  className="w-full justify-center text-white font-extrabold shadow-lg shadow-[#25D366]/20"
                >
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:col-span-7">
            {page.useCases.map((item, index) => {
              ...
              const description = typeof item === "string" || !item?.description
                ...
                : item.description;
              const keyStr = typeof item === "string" ? item : (item?.title || index.toString());
              return (
                <div
                  key={keyStr}
                ...
                >
                  ...
                  <div>
                    <h4 className="font-extrabold text-ink text-base">{title}</h4>
