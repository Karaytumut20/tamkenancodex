...
function BrandLogo({ brand }: { brand: string }) {
  return (
    <div className="flex h-16 w-[168px] shrink-0 items-center justify-center rounded-xl border border-border bg-white px-5 grayscale transition hover:border-primary-500 hover:grayscale-0">
