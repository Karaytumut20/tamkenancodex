  ...
  return (
    <section className="bg-surface py-4">
      <Container className="bg-transparent">
        <div className="desktop-grid min-h-[560px] items-center px-5 pb-6 pt-6 md:px-10 lg:pb-8 lg:pt-8">
          <div className="col-span-4 md:col-span-8 xl:col-span-5">
            <h1 className="max-w-3xl text-[clamp(40px,5vw,74px)] font-black leading-[0.94] tracking-[-0.065em] text-[#171923]">
              Sizin İçin Tasarlanan Akıllı Güvenlik Çözümleri
            </h1>
            <p className="mt-4 max-w-lg text-sm leading-6 text-[#6B7280] md:text-base">
          ...
          <div className="col-span-4 mt-10 md:col-span-8 xl:col-span-7 xl:mt-0">
            <div className="relative mx-auto h-[330px] max-w-[760px] md:h-[470px]">
              <div className="absolute left-[33%] top-[30%] z-10 rounded-full bg-white/80 px-4 py-2 text-xs font-black uppercase tracking-[0.12em] text-primary-600 shadow-[0_12px_35px_rgba(15,23,42,0.10)]">
                7/24 GÜVENLİK
              </div>
          ...
          <div className="col-span-4 md:col-span-8 xl:col-span-12">
            <div className="grid gap-3 md:grid-cols-[1fr_310px]">
              <div className="flex items-center rounded-[20px] bg-white p-4 shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
                <div className="flex flex-wrap items-center gap-4">
                  {trust.slice(0, 3).map((item) => (
                    <span key={item.label} className="inline-flex items-center gap-2 rounded-full bg-[#F7FAFF] px-4 py-2 text-xs font-extrabold text-ink">
                      <item.icon className="h-4 w-4 text-primary-600" /> {item.label}
                    </span>
                  ))}
                </div>
              </div>
              <div className="rounded-[20px] bg-primary-600 p-4 text-white shadow-[0_18px_50px_rgba(0,107,255,0.18)]">
