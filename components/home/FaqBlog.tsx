        ...
        <Container>
          <div className="grid gap-10 xl:grid-cols-12 xl:items-start">
            <div className="xl:col-span-5">
              ...
              <div className="mt-8 flex items-center gap-4 rounded-2xl border border-border hover:border-cyan-500 transition-colors duration-200 bg-white/50 p-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full gap-4">
                  ...
                  <ButtonLink
                    ...
                    variant="whatsapp"
                    className="px-5 py-2.5 rounded-xl flex items-center gap-2 text-sm font-extrabold shadow-md hover:shadow-lg shrink-0"
                  >
