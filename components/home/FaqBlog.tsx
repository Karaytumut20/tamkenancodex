        ...
        <Container>
          <div className="grid gap-10 xl:grid-cols-12 xl:items-start">
            <div className="xl:col-span-5">
              ...
              <div className="mt-8 rounded-2xl border border-border hover:border-cyan-500 transition-colors duration-200 bg-white/50 p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full gap-4">
                  ...
                  <ButtonLink
                    ...
                    variant="whatsapp"
                    className="px-5 py-2.5 rounded-xl flex items-center gap-2 text-sm font-extrabold shadow-md hover:shadow-lg shrink-0 w-full sm:w-auto justify-center"
                  >
            ...
            <div className="xl:col-span-7 space-y-3">
              {homeFaqs.map((faq, index) => (
                <div key={faq.question} className="rounded-xl border border-border hover:border-cyan-500 transition-colors duration-200 bg-white">
                  <button
        ...
        <Container>
          <div className="mb-8 flex items-end justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={handlePrev}
                className="flex h-10 w-10 items-center justify-center rounded-full bg-primary-600 text-white hover:bg-cyan-500 transition-colors duration-200 shadow-sm"
            ...
            >
              {blogPosts.map((post) => (
                ...
                >
                  <a
                    href={`/blog/${post.slug}`}
                    className="group flex w-full flex-col overflow-hidden rounded-[24px] border border-white bg-white p-4 transition hover:-translate-y-1 hover:border-cyan-500"
                  >
                    ...
                    <div className="flex flex-1 flex-col justify-between pt-4">
                      <div>
                        ...
                        <h3 className="mt-2 line-clamp-2 min-h-[44px] text-[15px] font-extrabold leading-tight text-ink group-hover:text-cyan-500">
                          {post.title}
                        </h3>
                      </div>
                      <div className="mt-4 flex items-center justify-between gap-3">
                        <span className="text-xs font-extrabold text-primary-600 transition group-hover:text-cyan-500">Oku</span>
                        <span className="mb-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-surface text-primary-600 shadow-sm group-hover:bg-cyan-500 group-hover:text-white transition-colors duration-300">
