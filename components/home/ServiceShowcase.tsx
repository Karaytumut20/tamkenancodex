            ...
            >
              ...
              <div className="flex flex-1 flex-col justify-between pt-4">
                <div>
                  ...
                  <h3 className="mt-2 line-clamp-2 min-h-[44px] text-[15px] font-extrabold leading-tight text-ink group-hover:text-primary-600 transition-colors">{product.name}</h3>
                </div>
