  ...
  return (
    <section className="bg-surface py-14">
      <div className="container-primesec grid gap-6 xl:grid-cols-2">
        <Link href="/kendi-sistemini-tasarla" className="group relative min-h-[320px] overflow-hidden rounded-[28px] border border-border bg-white p-8 text-ink shadow-[0_18px_50px_rgba(15,23,42,0.04)]">
          ...
          <div className="relative z-10 max-w-md">
            ...
            <span className="mt-8 inline-flex h-11 items-center justify-center rounded-full bg-primary-600 px-5 text-sm font-extrabold text-white shadow-[0_4px_14px_0_rgba(0,118,255,0.39)] group-hover:bg-primary-500 group-hover:shadow-[0_6px_20px_rgba(0,118,255,0.23)]">
              Başla <ChevronRight className="ml-2 h-4 w-4" />
            </span>
          </div>
        </Link>

        <div className="min-h-[320px] rounded-[28px] border border-border bg-white p-8 shadow-[0_18px_50px_rgba(15,23,42,0.04)]">
          <div className="flex h-full flex-col justify-between">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/kendi-sistemini-tasarla" className="inline-flex h-12 items-center justify-center rounded-full bg-primary-600 px-6 text-sm font-extrabold text-white shadow-[0_4px_14px_0_rgba(0,118,255,0.39)] hover:bg-primary-500">
                Sistemi Oluştur <Sparkles className="ml-2 h-4 w-4" />
              </Link>
              <Link href="/iletisim" className="inline-flex h-12 items-center justify-center rounded-full border border-border bg-transparent px-6 text-sm font-extrabold text-ink-muted hover:border-primary-600 hover:text-primary-600 transition-colors">
