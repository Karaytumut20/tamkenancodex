...
export function ProductCard({ product }: { product: Product }) {
  return (
    <article className="group flex aspect-[3/4.2] flex-col rounded-2xl border border-border bg-white p-4 hover:border-cyan-500 hover:-translate-y-1 hover:shadow-md transition-all duration-300">
