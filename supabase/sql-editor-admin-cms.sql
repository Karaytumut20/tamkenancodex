...
drop policy if exists "admin profiles read own or super admin" on public.admin_profiles;
drop policy if exists "super admin manages profiles" on public.admin_profiles;
...
drop policy if exists "content admins manage brands" on public.brands;
drop policy if exists "public reads active products" on public.products;
drop policy if exists "content admins manage products" on public.products;
drop policy if exists "public reads active services" on public.services;
drop policy if exists "content admins manage services" on public.services;
drop policy if exists "public reads published blog posts" on public.blog_posts;
drop policy if exists "content admins manage blog posts" on public.blog_posts;
drop policy if exists "public reads active service areas" on public.service_areas;
drop policy if exists "content admins manage service areas" on public.service_areas;
drop policy if exists "public reads site settings" on public.site_settings;
drop policy if exists "content admins manage site settings" on public.site_settings;
...
drop policy if exists "support admins manage lead notes" on public.lead_notes;
drop policy if exists "anonymous can insert system builder submissions" on public.system_builder_submissions;
drop policy if exists "support admins read system builder submissions" on public.system_builder_submissions;
drop policy if exists "super admin deletes system builder submissions" on public.system_builder_submissions;
drop policy if exists "public reads active builder options" on public.builder_options;
drop policy if exists "content admins manage builder options" on public.builder_options;
drop policy if exists "admins read media assets" on public.media_assets;
drop policy if exists "content admins insert media assets" on public.media_assets;
drop policy if exists "content admins update media assets" on public.media_assets;
drop policy if exists "content admins delete media assets" on public.media_assets;
...
drop policy if exists "content admins insert site media" on storage.objects;
drop policy if exists "content admins update site media" on storage.objects;
drop policy if exists "content admins delete site media" on storage.objects;
