...
export default async function AdminDashboardPage() {
  ...
  const actions = [
    ...
    },
    {
      ...
      title: "🗂️ Navbar (Mega Menü)",
      desc: "Üst menüdeki açılır kutuları ve ürünleri yönetin",
      bg: "bg-indigo-50 border-indigo-200 text-indigo-900 hover:bg-indigo-100",
    },
    {
      href: "/admin/oksid-sync",
      title: "🔄 Oksid XML Sync",
      desc: "Güvenlik ürünleri ve disk kategorilerini çek",
    ...
    },
    {
      ...
      desc: "Ana sayfa veya diğer SSS alanlarını yönetin",
      bg: "bg-fuchsia-50 border-fuchsia-200 text-fuchsia-900 hover:bg-fuchsia-100",
    },
    {
      href: "/admin/settings",
