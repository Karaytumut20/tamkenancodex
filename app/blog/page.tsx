...
export default function BlogPage() {
  ...
  return (
    <>
      <PageHero title="Güvenlik Sistemleri Blog" description="Alarm, kamera, akıllı ev, yangın güvenliği ve yerel güvenlik rehberleriyle doğru sistemi seçmenizi kolaylaştırıyoruz." image="/images/blog-security.svg" crumbs={[{ label: "Blog", href: "/blog" }]} />
      <section className="bg-[#F7FAFF] py-12">
        <Container>
          ...
          <Link href={`/blog/${featured.slug}`} className="grid overflow-hidden rounded-[24px] border border-border bg-white shadow-card md:grid-cols-2">
            <div className="relative min-h-[300px] bg-[#F7FAFF]">
            ...
            <div className="p-8">
              ...
              <h2 className="mt-3 text-3xl font-extrabold tracking-[-0.035em] text-ink">{featured.title}</h2>
              ...
              <Link key={post.slug} href={`/blog/${post.slug}`} className="group flex flex-col overflow-hidden rounded-2xl border border-border bg-white shadow-card   ">
                ...
                <div className="flex flex-1 flex-col justify-between p-5">
                  <div>
                    ...
                    <h2 className="mt-2 text-lg font-extrabold leading-6 text-ink group-hover:text-primary-600">{post.title}</h2>
