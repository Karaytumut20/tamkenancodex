    ...
    <>
      ...
      <section className="bg-surface py-12">
        <Container>
          ...
          <Link href={`/blog/${featured.slug}`} className="grid overflow-hidden rounded-[24px] border border-white/10 primesec-navy-surface md:grid-cols-2 group text-white relative">
