...
const siteSettingOptions = [
  ...
  { label: "Telefon (Genel)", value: "contact.phone" },
  ...
  { label: "1. Temsilci Adı", value: "contact.rep1.name" },
  { label: "1. Temsilci Telefon", value: "contact.rep1.phone" },
  { label: "1. Temsilci WhatsApp", value: "contact.rep1.whatsapp" },
  { label: "2. Temsilci Adı", value: "contact.rep2.name" },
...
const seoFields: AdminField[] = [
  ...
  { name: "focus_keyword", label: "Focus keyword", group: "seo" },
...
export const adminResources: Record<string, AdminResource> = {
  references: {
    ...
    description: "Referans firma adlarını ve logo bağlantılarını yönetin.",
    roles: contentRoles,
    canCreate: true,
    canEdit: true,
    canDelete: true,
    ...
    columns: [
      ...
      { key: "logo_url", label: "Logo Linki" },
      { key: "is_active", label: "Durum" },
    ],
    fields: [
      { name: "company_name", label: "Referans Firma Adı", required: true, group: "content" },
      { name: "logo_url", label: "Referans Logo Linki", required: true, group: "media", placeholder: "https://..." },
  ...
  faqs: {
    ...
    fields: [
      { name: "question", label: "Soru", required: true, group: "content" },
      { name: "answer", label: "Cevap", type: "textarea", required: true, group: "content" },
      { name: "sort_order", label: "Sıralama", type: "number", group: "settings", helpText: "Sayı ne kadar küçükse anasayfada o kadar üstte çıkar." },
      { name: "is_active", label: "Anasayfada Göster", type: "boolean", group: "publish" },
    ],
  },
  testimonials: {
    key: "testimonials",
  ...
  oksidProducts: {
    key: "oksidProducts",
    title: "XML Ürün Detayı",
    table: "oksid_urunler",
    path: "/admin/products",
    description: "XML ürününün iç detay sayfasında gösterilecek içerikleri düzenleyin.",
    roles: contentRoles,
    canCreate: false,
    canEdit: true,
    canDelete: false,
    searchable: ["urun_adi", "stok_kodu"],
    columns: [{ key: "urun_adi", label: "Ürün Adı" }],
    fields: [
      { name: "urun_adi", label: "Ürün Adı", required: true, group: "content" },
      { name: "stok_kodu", label: "Ürün Kodu", group: "content" },
      { name: "side_attributes", label: "Ürün Yanındaki Label'lar", type: "features_list", group: "content" },
      { name: "technical_attributes", label: "Alt Teknik Özellik Label'ları", type: "features_list", group: "content" },
      { name: "features", label: "Neden Bu Ürün? — Avantaj Kartları", type: "features_list", group: "content" },
      { name: "show_features", label: "Neden Bu Ürün? Bölümünü Göster", type: "boolean", group: "content" },
      { name: "specs_title", label: "Teknik Özellikler — Bölüm Başlığı", group: "content" },
      { name: "specs_description", label: "Teknik Özellikler — Bölüm Açıklaması", type: "textarea", group: "content" },
      { name: "show_specs", label: "Teknik Özellikler Bölümünü Göster", type: "boolean", group: "content" },
      { name: "benefits_title", label: "Akıllı Entegrasyon — Bölüm Başlığı", group: "content" },
      { name: "benefits_description", label: "Akıllı Entegrasyon — Bölüm Açıklaması", type: "textarea", group: "content" },
